export default function ProgrammingProject() {
    return <div className="project">
        ...
        <p className="subtitle">Updated: 11/14/24</p>
        <div className="project-body">
            ...
            <h3>Reflection</h3>
            <p>Having already had a lot of experience with programming and Arduino, these exercises were usually not very challenging for me, and doing them often felt repetitive. However, sometimes I did have trouble figuring out what each question was asking for. For example, some of the questions required me to change the structure of my loops even though my output was the same as what it showed in the diagram. In addition to doing my own exercises, I was also able to help others get unstuck. Overall, this unit gave me a lot of extra practice for making basic LED programs, but I would have liked to do more with Arduino.</p>
        </div>
    </div>
}